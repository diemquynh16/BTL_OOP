...
void MotorbikeBrand::fileout(string tenfile) {
	...
	for (int i = 0; i < _motorbikes.size(); i++) {
		 ...
		 filexuat << "|";
		 filexuat << _motorbikes[i]->getCC();
		 filexuat << "|";
		 filexuat << Tien(to_string(_motorbikes[i]->getGiaGoc()));
		 filexuat << "|";
		 filexuat << Tien(to_string(_motorbikes[i]->getGiaBan()));
		 filexuat << "|";
		 filexuat << _motorbikes[i]->getSL();
		 filexuat << "|";
